...
```{r ames_split, message = FALSE, warning = FALSE, cache = TRUE}
library(rsample)
set.seed(4595)
...
```{r recipes_max_example_2, cache = TRUE}
...
That covered slightly less than half the material that Max presented. I have to 
